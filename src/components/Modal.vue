...
<script setup>
    ...
    import { useModalStora } from '../stores/modal';
                        ...
                        <DialogPanel
                            ...
                            <div>
                                <div class="mt-3">
                                    ...
                                    <img :src="bebidasStore.receta.strDrinkThumb" :alt="`Imagen de la Receta: ${bebidasStore.receta.strDrink}`">

                                    <DialogTitle as="h3" class="text-gray-900 text-4xl font-extrabold my-5">
                                        Ingredientes y Cantidades:
                                    </DialogTitle>
                                    
                                    <div v-html="formatearIngrediantes().outerHTML"></div>
                                    ...
                                    <p class="text-lg text-gray-500">
                                        {{ bebidasStore.receta.strInstructionsES ?? bebidasStore.receta.strInstructions }}
                                    </p>
                                </div>
                            </div>
